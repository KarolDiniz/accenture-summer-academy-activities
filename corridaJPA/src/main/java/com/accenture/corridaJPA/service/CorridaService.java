package com.accenture.corridaJPA.service;
...
import com.accenture.corridaJPA.repository.CorridaRepository;
import com.accenture.corridaJPA.repository.LocalRepository;
...
public class CorridaService 
{
	...
	public ResponseEntity<Corrida> criarCorrida(@PathVariable(value = "localId") Long localId, @RequestBody Corrida corridaRequest) {
		Corrida corrida = localRepository
						  ...
						  .orElseThrow(() -> new RuntimeException("Local com ID " + localId + " não encontrado")); // Substituir por uma exceção apropriada
